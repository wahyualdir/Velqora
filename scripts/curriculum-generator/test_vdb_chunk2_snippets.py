...
json_files = [
    os.path.join(base_dir, f"vdb_ch{ch}_data.json") for ch in [5, 6, 7, 8]
]
...
print("=" * 70)
print("TEST RUNNER: Verifikasi Eksekusi Mandiri Snippet Kode Chunk 2 (Bab 5-8)")
print("=" * 70)

for ch_idx, json_file in enumerate(json_files, 5):
