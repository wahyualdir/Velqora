...
json_files = [
    os.path.join(base_dir, f"vdb_ch{ch}_data.json") for ch in [13, 14, 15]
]
...
print("=" * 70)
print("TEST RUNNER: Verifikasi Eksekusi Mandiri Snippet Kode Chunk 4 (Bab 13-15)")
print("=" * 70)

for ch_idx, json_file in enumerate(json_files, 13):
...
if failed_snippets:
    ...
    print("[SUKSES] Semua 30 snippet Python Chunk 4 teruji mandiri dan deterministik.")
