        ...
        <Card padding="none" className="divide-y divide-border/60">
          {modules.map((mod) => (
            <Link
              ...
              className="group flex items-center justify-between p-3.5 sm:px-4 hover:bg-surface-secondary/50 transition-colors"
            >
              <div className="space-y-1 min-w-0 flex-1 pr-3">
                ...
                <h3 className="text-xs sm:text-sm font-bold text-text-primary group-hover:text-brand-600 transition-colors leading-snug truncate font-display">
                  {mod.title}
                </h3>
                {mod.description && (
              ...
              <div className="shrink-0 flex items-center gap-1 text-xs font-semibold text-text-tertiary group-hover:text-brand-600 transition-colors">
