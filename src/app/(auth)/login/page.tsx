  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        // Trigger positive feedback animation before launching retro loading dialog
        setIsSuccess(true);
        toast.success(
          role === "owner"
        ...
        // Display authentic Retro OS loading dialog with terracotta blocks before entering dashboard
  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-between vt-desktop-bg text-[#1C1917] overflow-x-hidden selection:bg-[#C2553A]/20 selection:text-[#C2553A]">
        ...
        <div className="w-full max-w-[430px] mx-auto text-left space-y-3">
          ...
          >
            ...
            <div className="p-5 sm:p-6 bg-[#FAF8F5] dark:bg-[#141416] space-y-4">
                  ...
                  <form onSubmit={handleResetPassword} className="space-y-3.5 animate-fade-in-up">
                    <div className="space-y-1">
                      ...
                      <div className="relative flex items-center border-t-2 border-l-2 border-[#7A756D] dark:border-t-[#09090B] dark:border-l-[#09090B] border-b border-r border-[#FFFFFF] dark:border-b-[#3F3F46] dark:border-r-[#3F3F46] bg-[#FFFFFF] dark:bg-[#121214]">
                        ...
                        <input
                          ...
                          required
                          autoComplete="email"
                          className="w-full bg-transparent pl-9 pr-3 py-2 text-sm font-sans text-[#1C1917] dark:text-zinc-100 placeholder:text-[#8A8378] dark:placeholder:text-zinc-500 focus:outline-hidden disabled:opacity-50"
                        />
                      </div>
                    </div>
                    ...
                    <div className="text-center pt-1">
                      <button
                        ...
                        className="text-xs font-mono text-[#853827] dark:text-brand-400 hover:underline cursor-pointer"
                      >
                        ← Kembali ke Halaman Masuk
                      </button>
                    </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    <button
                      ...
                      disabled={loading}
                      className="flex items-center justify-center gap-2 py-2 px-3 vt-btn-chrome text-xs font-mono font-bold disabled:opacity-50 cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="flex items-center justify-center gap-2 py-2 px-3 vt-btn-chrome text-xs font-mono font-bold disabled:opacity-50 cursor-pointer text-[#1C1917] dark:text-zinc-200"
                    >
                  ...
                  <div className="relative my-3">
                    <div className="absolute inset-0 flex items-center">
                      <div className="w-full border-t border-[#7A756D]/30 dark:border-zinc-700" />
                    </div>
                    <div className="relative flex justify-center text-[10px] uppercase tracking-wider font-mono">
                      <span className="bg-[#FAF8F5] dark:bg-[#18181B] px-2.5 py-0.5 text-[#853827] dark:text-brand-400 font-bold">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-3.5 pt-0.5">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center justify-between pt-1 text-xs font-mono">
                        <label className="flex items-center gap-1.5 text-[#524B42] dark:text-zinc-400 hover:text-[#1C1917] dark:hover:text-zinc-200 cursor-pointer select-none">
                          <input
                            type="checkbox"
                            checked={rememberMe}
                        ...
                        <button
                          ...
                          className="text-[11px] text-[#853827] dark:text-brand-400 hover:underline cursor-pointer"
                        >
                          Lupa password?
                        </button>
                      </div>
              ...
              <MonsterCompanion focusedField={focusedField} loading={loading} />
            </div>
      ...
      <RetroLoadingDialog
        ...
        title="Loading..."
        subtitle="Menginisialisasi sesi & workspace akademik..."
        durationMs={2200}
        totalBlocks={20}
        onComplete={() => {
