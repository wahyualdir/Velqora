...
import { getAllFlatScikitLearnSections } from "./scikit-learn-curriculum";
...
/**
 * Kurikulum Lengkap: Machine Learning (Resmi Berbasis Scikit-Learn 1.9 User Guide)
 * Memuat seluruh bab utama dan subbab terstruktur lengkap dengan formulasi matematis dan kode Python runnable.
 */
export function getMachineLearningSections(): ModuleSection[] {
  const flat = getAllFlatScikitLearnSections();
