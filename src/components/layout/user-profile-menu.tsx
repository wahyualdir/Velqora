      ...
      <div className="relative w-full" ref={menuRef}>
        ...
        {isOpen && (
          <div className="absolute left-0 bottom-full mb-2.5 w-72 sm:w-80 rounded-2xl bg-surface border border-border shadow-xl p-4 z-50 animate-fade-in space-y-4">
            <div className="flex items-center gap-3.5 p-3 rounded-xl bg-surface-secondary border border-border">
              ...
              <div className="flex flex-col min-w-0 flex-1">
                ...
                <span className="text-[11px] text-text-secondary font-mono truncate">{userEmail}</span>
                ...
                <div className="mt-1.5 flex items-center gap-1.5">
                  {isOwner ? (
                    ...
                    <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-brand-500/15 text-brand-700 dark:text-brand-400 border border-brand-500/30">
                  ...
                  {isGoogleUser && (
                    <span className="text-[10px] px-1.5 py-0.5 rounded-md bg-surface-secondary text-text-secondary border border-border">
                      Google
                    </span>
                  )}
                </div>
            ...
            <div className="space-y-1.5">
              <button
                ...
                onClick={() => fileInputRef.current?.click()}
                disabled={uploadingPhoto}
                className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-semibold text-text-primary hover:bg-surface-secondary border border-border/60 hover:border-border transition-all text-left cursor-pointer"
              >
            ...
            <div className="border-t border-border pt-2">
              <button
                ...
                className="w-full flex items-center justify-center gap-2.5 px-3 py-2.5 rounded-xl text-xs font-bold text-rose-700 dark:text-rose-400 bg-rose-500/10 border border-rose-500/20 hover:bg-rose-500/20 hover:border-rose-500/40 active:scale-[0.98] transition-all duration-150 shadow-2xs cursor-pointer"
              >
                <LogOut className="w-4 h-4 shrink-0 text-rose-700 dark:text-rose-400" />
  ...
  return (
    <div className="relative inline-block" ref={menuRef}>
      ...
      <button
        ...
        className="flex items-center gap-2 p-1 sm:px-2.5 sm:py-1.5 rounded-full border border-border/80 bg-surface hover:bg-surface-secondary hover:border-border transition-all duration-150 active:scale-95 group focus:outline-none cursor-pointer"
      >
        <div className="relative shrink-0">
        ...
        <div className="absolute right-0 mt-2.5 w-72 sm:w-80 rounded-2xl bg-surface border border-border shadow-xl p-4 z-50 animate-fade-in space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <Link
              ...
              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-semibold text-text-primary hover:bg-surface-secondary border border-border/60 hover:border-border transition-all cursor-pointer"
            >
              <div className="w-7 h-7 rounded-lg bg-surface-secondary border border-border/80 flex items-center justify-center text-brand-600 shrink-0">
