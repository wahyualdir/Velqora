          ...
          >
            <div className="space-y-4">
              ...
              <div className="space-y-3 pt-2 font-mono">
                ...
                {/* Stat 3: Computational Notebook & Python 3.12 */}
                <div className="p-3 bg-[#FAF8F5] dark:bg-[#18181B] border border-[#E5DDD5] dark:border-zinc-800 rounded-xs space-y-1.5">
                  <div className="flex items-center justify-between text-xs">
                    <span className="font-bold text-[#1C1917] dark:text-zinc-100">COMPUTATIONAL NOTEBOOK &amp; PYTHON 3.12</span>
                    <span className="text-[#F59E0B] font-bold">PROVENANCE RUNTIME</span>
                  </div>
                  <div className="w-full h-2 bg-[#E5DDD5] dark:bg-zinc-800 rounded-none overflow-hidden">
                    <div className="h-full bg-[#F59E0B] w-full" />
                  </div>
                  <div className="text-[10px] text-[#7A756D] dark:text-zinc-400">
                    Dilengkapi eksekusi runtime Python 3.12 terisolasi, formula KaTeX, dan scaffolding 5-tingkat.
                  </div>
                </div>
              </div>
            </div>
