      ...
      >
        <div className="space-y-2">
          ...
          <p className="text-xs sm:text-sm text-[#524B42] dark:text-zinc-400 font-sans max-w-2xl leading-relaxed">
            Akses kurikulum akademik komprehensif 28 disiplin keilmuan, uji pemahaman dengan computational notebook terverifikasi, 
            dan kuasai materi AI, Machine Learning, Sains Data, hingga Rekayasa Sistem bersama Velqora.
          </p>
        </div>
