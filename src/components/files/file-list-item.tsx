...
export function FileListItem({
  ...
  return (
    <>
      <div className="group flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3.5 sm:p-4 rounded-xl border border-border bg-surface hover:border-border-hover hover:bg-surface-secondary/40 transition-all shadow-2xs">
        {/* Left: Icon & File Meta */}
